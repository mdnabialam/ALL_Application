package com.sbms.alam.server.restController;
...
import com.sbms.alam.server.entity.CustomerEvent;
...
public class UserRestController {
	...
	public ResponseEntity<Mono<CustomerEvent>> getEvent() {
		CustomerEvent event = new CustomerEvent("MD NABI ALAM", new Date());
	...
	public ResponseEntity<Flux<CustomerEvent>> getEnents(){
